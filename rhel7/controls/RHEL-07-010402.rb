...
# START_DESCRIBE RHEL-07-010402
  ...
  if command('grep services /etc/sssd/sssd.conf |grep -i pam').exit_status == 0
    describe command('grep offline_credentials_expiration /etc/sssd/sssd.conf | awk \'{print $3}\'') do
